    ...
    <div className="min-h-screen bg-white text-black overflow-x-hidden">
      ...
      <section className="pb-20">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          ...
          {/* BOX 1 */}
          <div className="rounded-xl p-6 border border-white/30 bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-500 text-white shadow-lg backdrop-blur-md hover:scale-[1.02] hover:shadow-2xl transition-all duration-300">
...
function IndustryCard({ title, desc, image, link }) {
  return (
    <div className="relative min-w-[900px] h-[620px] snap-center rounded-2xl overflow-hidden shadow-lg">
