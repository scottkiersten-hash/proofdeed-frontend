...
export default function AutomotiveCertificate() {
  ...
  const verifyUrl = `${window.location.origin}${__BASE_PATH__}verify?cert=PD-AUTO-2024-C29X7L`;
        ...
        <div className="bg-white border-2 border-slate-900 rounded-lg p-12 shadow-lg print:shadow-none">
          ...
          <div className="text-center mb-10 pb-8 border-b-2 border-slate-200">
            ...
            <h2 className="text-2xl font-bold text-slate-900">
              Certificate of Vehicle Record Integrity
            </h2>
          </div>
          ...
          <div className="space-y-8 mb-10">
            ...
            <div className="text-center py-6">
              <p className="text-lg text-slate-700 leading-relaxed">
                This certificate verifies that a cryptographic fingerprint of the referenced vehicle record
                was generated and permanently anchored to the Polygon blockchain at the timestamp indicated
                below.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-lg font-mono text-slate-900">AUTO-2026-VR82LM</p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-lg font-mono text-slate-900">1HGCM82633A004352</p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-sm font-mono text-slate-900 break-all">
                  d4e8b2a1f6c93750e12d84a7b3f6c9e0a5d7b2c4f8e1a3069b7d5c2e4f8a1b6
                </p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-lg text-slate-900">2026-02-08T09:17:43Z (UTC)</p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-sm font-mono text-slate-900 break-all">
                  0x3b7e9a2d1f4c8065e7a3b9d2c6f1e4a80d5b7c3e9f2a1640c8d5e7b3a9f2c16
                </p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-lg font-mono text-slate-900">72,104,587</p>
              </div>
              ...
              <div className="border-l-4 border-slate-900 pl-4">
                ...
                <p className="text-lg text-slate-900">Pre-Sale Vehicle Condition Report</p>
              </div>
          ...
          <div className="pt-8 border-t-2 border-slate-200">
            <div className="bg-slate-50 rounded-lg p-6">
              ...
              <p className="text-sm text-slate-700 leading-relaxed">
                <strong>Important:</strong> ProofDeed does not store vehicle records. This certificate
                proves only that a cryptographic fingerprint was generated and anchored at the
                specified time.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-slate-300">
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-sm font-semibold text-slate-900">February 8, 2026</p>
              </div>
