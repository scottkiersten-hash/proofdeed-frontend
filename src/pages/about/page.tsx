          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-slate-50 rounded-2xl p-8 md:p-12 mb-12">
              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                ProofDeed provides cryptographic proof that real estate and property-related documents existed at a specific point in time.
              </p>
              
              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                We generate a secure digital fingerprint (hash) of a document and anchor it to a public blockchain, creating independently verifiable, tamper-evident proof — without storing the document itself.
              </p>
              
              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                ProofDeed is designed for property owners, title companies, legal professionals, and institutions that require clear, verifiable evidence of document integrity and existence.
              </p>
              
              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                We do not act as a law firm, title company, or escrow service. ProofDeed does not modify, interpret, or store legal documents. Our role is limited to generating and verifying cryptographic proof.
              </p>
              
              <p className="text-lg font-semibold text-slate-900 leading-relaxed">
                ProofDeed exists to make document verification simple, transparent, and trustworthy.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-xl border-2 border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Your documents never leave your control. We only process cryptographic hashes.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl border-2 border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Blockchain-anchored proofs cannot be altered, deleted, or backdated.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-2xl p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a 
                  href="mailto:info@proofdeed.com?subject=Sales Inquiry" 
                  className="w-full sm:w-auto px-8 py-4 text-base font-semibold text-blue-600 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors whitespace-nowrap cursor-pointer"
                >
                  Talk to Sales
                </a>
              </div>
